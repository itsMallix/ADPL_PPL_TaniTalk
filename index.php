    ...
    <body id="page-top">
        ...
        <nav class="navbar navbar-expand-lg navbar-light fixed-top py-3" id="mainNav">
            <div class="container px-4 px-lg-5">
                <a class="navbar-brand" href="#page-top">TaniTalk</a>
            ...
            <div class="container px-4 px-lg-5 h-100">
                <div class="row gx-4 gx-lg-5 h-100 align-items-center justify-content-center text-center">
                    <div class="col-lg-8 align-self-end">
                        <h1 class="text-white font-weight-bold">Mempermudah Proses Monitoring Kebun Mu</h1>
                        <hr class="divider" />
                    </div>
                    <div class="col-lg-8 align-self-baseline">
                        <p class="text-white-75 mb-5">TaniTalk hadir untuk membantu para petani dan pengelelola dalam hal melakukan kegiatan monitoring pada kebun miliknya</p>
        ...
        <section class="page-section" id="services">
            <div class="container px-4 px-lg-5">
                <h2 class="text-center mt-0">Fitur Utama</h2>
                <hr class="divider" />
                <div class="row gx-4 gx-lg-5">
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><i class="bi-gem fs-1 text-primary"></i></div>
                            <h3 class="h4 mb-2">Identifikasi Penyakit</h3>
                            <p class="text-muted mb-0">Cari tahu penyakit tanaman anda dan dapatkan solusi!</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                          <div class="mb-2"><i class="bi-laptop fs-1 text-primary"></i></div>
                            <h3 class="h4 mb-2">kalkulasi Pupuk</h3>
                            <p class="text-muted mb-0">Cukup mudah melakukan perhitungan pupuk yang digunakan!</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><i class="bi-globe fs-1 text-primary"></i></div>
                            <h3 class="h4 mb-2">Prakiraan Cuaca</h3>
                            <p class="text-muted mb-0">Lihat prakiraan cuaca di daerah anda secara langsung!</p>
                        </div>
                    </div>
                    <div class="col-lg-3 col-md-6 text-center">
                        <div class="mt-5">
                            <div class="mb-2"><i class="bi-heart fs-1 text-primary"></i></div>
                            <h3 class="h4 mb-2">Rekapitulasi</h3>
                            <p class="text-muted mb-0">Permudah rekapitulasi pencatatan kegiatan pertanian anda</p>
                        </div>
                    </div>
                </div>
            </div>
        ...
        <footer class="bg-light py-5">
            <div class="container px-4 px-lg-5"><div class="small text-center text-muted">Copyright &copy; 2023 - TaniTalk</div></div>
        </footer>
        <!-- Bootstrap core JS-->
